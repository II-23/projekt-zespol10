...
while running:
    ...
    if game_status == MENU:
        ...
        pokaz_napis(screen, "Musisz zakonczyc sciezke na ktorejs z widocznych kratek!", 'res/czcionki/FFFFORWA.TTF',
                    WHITE, 16, 320, 570)
        ...
        if game.czy_fala_idzie == True:
            ...
            if pygame.time.get_ticks() - czas_spawnu_wroga > 500 + random.randint(1,
                                                                                  300):  # 500 to stun miedzy spawnowaniem kolejnych wrogow
            ...
            if len(napisy) == 0:
                n = Napis_czasowy(screen, "Fala " + str(game.wave), "res/czcionki/FFFFORWA.TTF", "#603fef", 80, 400,
                                  300, 40 * FPS)
                napisy.append(n)
